...
const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `Darlyn | 𓈃ּ ៹🍏𝗱𝑎𝙧̲𝘭𝐲̲𝘯̲𐂂!s⁹⁷☻‹𝟹 `, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./Darlyn/darlyn.jpg`),"sourceUrl": "https://appweb-darlyn.vercel.app"}}}, { quoted: m})
        }
...
switch(command) {
        case 'inventori': case 'inventory': case 'profile': case 'perfil':{
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     await XeonBotInc.send5ButImg(from, `` + '' + teksehmazeh, `© ${footer}`, xeonbotinc, [{"urlButton": {"displayText": "Web📍","url": `${sc}`}}])
  }
  break
        case 'userlimit': 
{      
          ...
          case 'lesbiancheck':
             case 'hornycheck':
                 case 'prettycheck':
                    case 'lovelycheck':
                      case 'uglycheck':
				if (!text) return replay(`Tag Someone, Example : ${prefix + command} @darlynxd`)
...
XeonBotInc.sendMessage(from, { text: `*${command}*\n\nName : ${q}\nAnswer : *${sange}%*` }, { quoted: m })
					...
					case 'charactercheck':
					//YouTube📍 by xeon⛔\\
					if (!text) return replay(`Tag Someone, Example : ${prefix + command} @darlyn`)
...
/// (%(ip)s) IP EN PYTHON
        ...
        if (stderr.trim()) reply(stderr)
            ...
            break
            case 'owner': case 'creador': case 'darlyn': {
                ...
                listMessage :{
                    ...
                    sections: [{
								...
								"rows": [
									{
										"title": "Main Menu",
										"description": "Muestra la lista de comandos principales",
							...
							},
							{
								...
								"rows": [
									...
									{
										"title": "Owner Menu",
										"description": "Muestra la lista de comandos del propietario",
									...
									{
										"title": "Rpg Menu",
										"description": "Muestra la lista de comandos de Rpg",
									...
									{
											"title": "Random Menu",
										"description": "Muestra la lista de características aleatorias",
										"rowId": `${prefix}randommenu`
										},
										{
											"title": "Random Anime Menu",
										"description": "Muestra la lista de características aleatorias de anime",
										...
										{
											"title": "Islamic Menu",
										"description": "Muestra la lista de características islámicas",
										"rowId": `${prefix}islamicmenu`
										},
										{
											"title": "Horoscope Menu",
										"description": "Muestra la lista de características del horóscopo",
