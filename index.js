...
async function startXeonBotInc() {
    const XeonBotInc = XeonBotIncConnect({
        ...
        browser: ['Darlyn Bot V4','Safari','1.0.0'],
        auth: state
    })
    ...
    // Get Profile Picture Group
       ...
       XeonBotInc.send5ButImg(pea[0].id, `「 Configuración de grupo cambiada 」\n\nGrupo cerrado, solo los administradores pueden enviar mensajes`, `𓈃ּ ៹🍏𝗱𝑎𝙧̲𝘭𝐲̲𝘯̲𐂂!s⁹⁷☻‹𝟹`, wm_fatih, [])
       } else if(pea[0].announce == false) {
       XeonBotInc.send5ButImg(pea[0].id, `「 Configuración de grupo cambiada 」\n\nGrupo abierto, ahora todos los participantes pueden enviar mensajes`, `𓈃ּ ៹🍏𝗱𝑎𝙧̲𝘭𝐲̲𝘯̲𐂂!s⁹⁷☻‹𝟹`, wm_fatih, [])
       } else if (pea[0].restrict == true) {
       XeonBotInc.send5ButImg(pea[0].id, `「 Configuración de grupo cambiada 」\n\nLa información del grupo ha sido restringida, ¡ahora solo el administrador puede editar la información del grupo`, `𓈃ּ ៹🍏𝗱𝑎𝙧̲𝘭𝐲̲𝘯̲𐂂!s⁹⁷☻‹𝟹`, wm_fatih, [])
       } else if (pea[0].restrict == false) {
       XeonBotInc.send5ButImg(pea[0].id, `「 Configuración de grupo cambiada 」\n\nSe ha abierto la información del grupo, ahora los participantes pueden editar la información del grupo`, `𓈃ּ ៹🍏𝗱𝑎𝙧̲𝘭𝐲̲𝘯̲𐂂!s⁹⁷☻‹𝟹`, wm_fatih, [])
       } else {
       XeonBotInc.send5ButImg(pea[0].id, `「 Configuración de grupo cambiada 」\n\nEl asunto del grupo se ha cambiado a ${pea[0].subject}`, `𓈃ּ ៹🍏𝗱𝑎𝙧̲𝘭𝐲̲𝘯̲𐂂!s⁹⁷☻‹𝟹`, wm_fatih, [])
     }
    })
